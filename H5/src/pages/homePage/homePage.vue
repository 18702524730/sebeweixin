<template>
  <div class="homepage">
    ...
    <div class="trademark_lists">
      ...
      <ul class="list_data">
        <li class="clearfix" v-for="item in datalist" @click="goShopping(item.id)">
    ...
    <div class="cooperation">
      <ul class="clearfix">
        <li class="fl mvl"><img class="csj" src="~assets/img/homepage/csj.png" alt=""></li>
        <li class="fl"><img class="albb" src="~assets/img/homepage/albb.png" alt=""></li>
        <li class="fl"><img class="caasa" src="~assets/img/homepage/caasa.jpg"  alt=""></li>
        <li class="fl"><img class="number" src="~assets/img/homepage/360.png" alt=""></li>
        <li class="fl mvl"><img class="jd" src="~assets/img/homepage/jd.png" alt=""></li>
        <li class="fl"><img class="honor" src="~assets/img/homepage/honor.png" alt=""></li>
        <li class="fl"><img class="baidu" src="~assets/img/homepage/baidu.png" alt=""></li>
        <li class="fl"><img class="huic" src="~assets/img/homepage/huic.png" alt=""></li>
      </ul>
    </div>
    <div class="footer">
      ...
      <img src="~assets/img/homepage/caasa1.png" height="38" alt="">
      <p>杭州拾贝知识产权服务有限公司为</p>
      <p>中国产学研合作促进会反侵权假冒创新战略联盟理事长单位</p>
      <hr>
...
@import  "~assets/css/adaptation.scss";
  .homepage{
    ...
    .banner{height:500px;background:url(~assets/img/homepage/banner.jpg) no-repeat;background-size:100%;padding:30px;
    ...
    .platform{background-color:#fff;padding:px(90) 0;border-top:px(1) solid #ddd;
      .platform_bgu{height:px(966);width:px(750);text-align:center;background-position:bottom;
        div{width:px(640);height:px(768);background:url(~assets/img/homepage/Group.png) no-repeat;background-size:100%;margin:0 auto;padding-top: px(144);
