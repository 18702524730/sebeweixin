<template>
  <div class="helpWrap">
    ...
    <div class="intro">24小时内极速响应，紧急业务请致电<b @click="makePhone">4000-315-426</b></div>
...
<style lang="scss">
.helpWrap{background: #fff;margin-top: 20px;padding: 0 20px;position: relative;
  ...
  .intro{font-size: 24px;line-height: 33px;color:rgba(153,153,153,1);position: absolute;bottom:-63px;width: 100%;text-align: center;left: 0;
    >b{display: inline;line-height: 33px;font-size: 24px;color:#2F80F6;}
  }
}
