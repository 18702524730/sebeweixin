...
<style lang="scss">
  .u_message {
    .i-message{
      display:block;width:750px;min-height:64px;line-height:2.3;position:fixed;top:0;left:0;right:0;background:#2d8cf0;color:#fff;text-align:center;font-size:28px;z-index:10100;opacity:0;-webkit-transform:translateZ(0) translateY(-100%);transition:all .4s ease-in-out;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;}
