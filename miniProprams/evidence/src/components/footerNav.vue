...
<script>
  ...
  import icon_3 from '../assets/img/icon/outpatient.png'
  import icon_3_active from '../assets/img/icon/outpatientActive.png'
  import icon_2 from '../assets/img/icon/store.png'
  import icon_2_active from '../assets/img/icon/storeActive.png'
  ...
  export default {
    ...
    data () {
      return {
        navDataList: navData,
        activeIndex: 0,
        icon: [icon_2, icon_3, icon_4, icon_5],
        activeIcon: [icon_2_active, icon_3_active, icon_4_active, icon_5_active]
      }
    },
    async mounted() {
    ...
    methods: {
      selectNavFn (index) {
        ...
        switch (index) {
          ...
          case 0: url = '/pages/store/index'; break;
          case 1: url = '/pages/outpatient/index'; break;
          case 2: url = '/pages/toolbox/index'; break;
          case 3: url = '/pages/my/index'; break;
        }
        wx.redirectTo({
          url: url
        })
...
<style lang="scss">
  .pub_footer_nav {
    ...
    .nav_link {
      ...
      width: 25%; height: 98px; padding-top: 10px; box-sizing:border-box; text-align: center; position: relative;
      .img_box {
      ...
      .icon {}
      .txt {font-size: 20px; color: #999; width: 100%; text-align: center;line-height: 32px;padding: 7px 0 4px;}
      &.active {
        .txt {color: #4272FF; }
      }
    }
