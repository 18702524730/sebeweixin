...
import qs from 'qs';
const miniAppType = 7; //1公众号 2 微商城小程序 3 推单助手小程序 4商标管家 5合伙人B 6合伙人C 7公正存证
...
const interfaces = {
   ...
   */
    ...
    if (token) {
      ...
      header['cookie'] = 'user_token=' + token + ';';
    }
    if (sessionId) {
  ...
  async getSession(code) {
    ...
    const data = await http.post(url, {code, miniAppType}, {}, { isLoading: false });
    return data;
  },
